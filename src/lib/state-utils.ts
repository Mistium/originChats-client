...
function updateByServer<T>(signal: ByServerSignal<T>, sUrl: string, value: T): void {
...
function ensureServerState<T>(signal: ByServerSignal<T>, sUrl: string, defaultValue: T): void {
