...
export function CrackedAuthModal() {
  ...
  if (view === "choice" && hasRoturToken) {
    return (
      <Modal isOpen={isOpen} onClose={handleClose} title="Server Authentication">
        <div className="cracked-auth-modal">
          <div className="cracked-auth-warning">
            ...
            <div className="cracked-auth-warning-content">
              ...
              <p>
                You can continue with your Rotur account for full access, or create a
                server-specific account for this server only.
              </p>
            </div>
          </div>

          <div className="cracked-auth-choice-options">
            <button className="cracked-auth-choice-btn primary" onClick={handleUseRoturAccount}>
              <div className="cracked-auth-choice-icon">
                <Icon name="User" size={20} />
              </div>
              <div className="cracked-auth-choice-content">
                <div className="cracked-auth-choice-title">Use Rotur Account</div>
            ...
            >
              ...
              <div className="cracked-auth-choice-content">
                <div className="cracked-auth-choice-title">Create Server Account</div>
                <div className="cracked-auth-choice-desc">Account specific to this server only</div>
              </div>
            </button>
          </div>
        </div>
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Cracked Authentication">
      <div className="cracked-auth-modal">
        {hasRoturToken && (
          <button className="cracked-auth-back-btn" onClick={() => setView("choice")}>
        ...
        <div className="cracked-auth-warning">
          ...
          <div className="cracked-auth-warning-content">
            ...
            <p>
              {serverName} uses cracked authentication. This account is specific to this server and
